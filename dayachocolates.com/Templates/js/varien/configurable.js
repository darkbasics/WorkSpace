...
Product.Config.prototype = {
    ...
    configureElement : function(element) {
		...
		//alert('image:' + assocIMG[productNo]);
		jQuery('.product-img-box .product-image img').attr('src', assocIMG[productNo]) ;//= assocIMG[productNo];
		//alert(jQuery('.product-img-box .product-image img').length);
    },
